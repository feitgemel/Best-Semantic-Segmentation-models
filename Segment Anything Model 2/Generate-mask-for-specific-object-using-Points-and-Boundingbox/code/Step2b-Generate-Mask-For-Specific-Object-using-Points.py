...
# Points as input for the small elephant in the image
input_point = np.array([[1476, 830]])
...
# With multimask_output=True, the model returns 3  masks as output
...
# -------------------------------------------------
# Lets use supervision , and also lets predict masks using multiple points

image_bgr = cv2.imread("code/Elephant2.jpg")
...
# Show the masks using supervision
sv.plot_images_grid(
    images=masks,
...
# Specify a specific object using multiple points
